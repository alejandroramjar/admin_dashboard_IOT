...
urlpatterns = [
    ...
    path('consultar_id/<int:id>/', consultar_id, name='consultar_id'),
    ...
    path('user/dispositivo/<int:pk>/data/', DispositivoDataViewSet.as_view({'get': 'retrieve'}),
         name='dispositivo-data'),
